...
#define BUILD_STATUS_CODE(name)	{ name, #name }

#define TDX_SEAMCALL_STATUS_CODES	\
	BUILD_STATUS_CODE(TDX_NON_RECOVERABLE_VCPU),			\
	BUILD_STATUS_CODE(TDX_NON_RECOVERABLE_TD),			\
	BUILD_STATUS_CODE(TDX_INTERRUPTED_RESUMABLE),			\
	BUILD_STATUS_CODE(TDX_INTERRUPTED_RESTARTABLE),			\
	BUILD_STATUS_CODE(TDX_NON_RECOVERABLE_FATAL),			\
	BUILD_STATUS_CODE(TDX_INVALID_RESUMPTION),			\
	BUILD_STATUS_CODE(TDX_NON_RECOVERABLE_TD_NO_APIC),		\
	BUILD_STATUS_CODE(TDX_OPERAND_INVALID),				\
	BUILD_STATUS_CODE(TDX_OPERAND_ADDR_RANGE_ERROR),		\
	BUILD_STATUS_CODE(TDX_OPERAND_BUSY),				\
	BUILD_STATUS_CODE(TDX_PREVIOUS_TLB_EPOCH_BUSY),			\
	BUILD_STATUS_CODE(TDX_SYS_BUSY),				\
	BUILD_STATUS_CODE(TDX_PAGE_METADATA_INCORRECT),			\
	BUILD_STATUS_CODE(TDX_PAGE_ALREADY_FREE),			\
	BUILD_STATUS_CODE(TDX_PAGE_NOT_OWNED_BY_TD),			\
	BUILD_STATUS_CODE(TDX_PAGE_NOT_FREE),				\
	BUILD_STATUS_CODE(TDX_TD_ASSOCIATED_PAGES_EXIST),		\
	BUILD_STATUS_CODE(TDX_SYSINIT_NOT_PENDING),			\
	BUILD_STATUS_CODE(TDX_SYSINIT_NOT_DONE),			\
	BUILD_STATUS_CODE(TDX_SYSINITLP_NOT_DONE),			\
	BUILD_STATUS_CODE(TDX_SYSINITLP_DONE),				\
	BUILD_STATUS_CODE(TDX_SYS_NOT_READY),				\
	BUILD_STATUS_CODE(TDX_SYS_SHUTDOWN),				\
	BUILD_STATUS_CODE(TDX_SYSCONFIG_NOT_DONE),			\
	BUILD_STATUS_CODE(TDX_TD_NOT_INITIALIZED),			\
	BUILD_STATUS_CODE(TDX_TD_INITIALIZED),				\
	BUILD_STATUS_CODE(TDX_TD_NOT_FINALIZED),			\
	BUILD_STATUS_CODE(TDX_TD_FINALIZED),				\
	BUILD_STATUS_CODE(TDX_TD_FATAL),				\
	BUILD_STATUS_CODE(TDX_TD_NON_DEBUG),				\
	BUILD_STATUS_CODE(TDX_TDCX_NUM_INCORRECT),			\
	BUILD_STATUS_CODE(TDX_VCPU_STATE_INCORRECT),			\
	BUILD_STATUS_CODE(TDX_VCPU_ASSOCIATED),				\
	BUILD_STATUS_CODE(TDX_VCPU_NOT_ASSOCIATED),			\
	BUILD_STATUS_CODE(TDX_TDVPX_NUM_INCORRECT),			\
	BUILD_STATUS_CODE(TDX_NO_VALID_VE_INFO),			\
	BUILD_STATUS_CODE(TDX_MAX_VCPUS_EXCEEDED),			\
	BUILD_STATUS_CODE(TDX_TSC_ROLLBACK),				\
	BUILD_STATUS_CODE(TDX_FIELD_NOT_WRITABLE),			\
	BUILD_STATUS_CODE(TDX_FIELD_NOT_READABLE),			\
	BUILD_STATUS_CODE(TDX_TD_VMCS_FIELD_NOT_INITIALIZED),		\
	BUILD_STATUS_CODE(TDX_KEY_GENERATION_FAILED),			\
	BUILD_STATUS_CODE(TDX_TD_KEYS_NOT_CONFIGURED),			\
	BUILD_STATUS_CODE(TDX_KEY_STATE_INCORRECT),			\
	BUILD_STATUS_CODE(TDX_KEY_CONFIGURED),				\
	BUILD_STATUS_CODE(TDX_WBCACHE_NOT_COMPLETE),			\
	BUILD_STATUS_CODE(TDX_HKID_NOT_FREE),				\
	BUILD_STATUS_CODE(TDX_NO_HKID_READY_TO_WBCACHE),		\
	BUILD_STATUS_CODE(TDX_WBCACHE_RESUME_ERROR),			\
	BUILD_STATUS_CODE(TDX_FLUSHVP_NOT_DONE),			\
	BUILD_STATUS_CODE(TDX_NUM_ACTIVATED_HKIDS_NOT_SUPPORRTED),	\
	BUILD_STATUS_CODE(TDX_INCORRECT_CPUID_VALUE),			\
	BUILD_STATUS_CODE(TDX_BOOT_NT4_SET),				\
	BUILD_STATUS_CODE(TDX_INCONSISTENT_CPUID_FIELD),		\
	BUILD_STATUS_CODE(TDX_CPUID_LEAF_1F_FORMAT_UNRECOGNIZED),	\
	BUILD_STATUS_CODE(TDX_INVALID_WBINVD_SCOPE),			\
	BUILD_STATUS_CODE(TDX_INVALID_PKG_ID),				\
	BUILD_STATUS_CODE(TDX_CPUID_LEAF_NOT_SUPPORTED),		\
	BUILD_STATUS_CODE(TDX_SMRR_NOT_LOCKED),				\
	BUILD_STATUS_CODE(TDX_INVALID_SMRR_CONFIGURATION),		\
	BUILD_STATUS_CODE(TDX_SMRR_OVERLAPS_CMR),			\
	BUILD_STATUS_CODE(TDX_SMRR_LOCK_NOT_SUPPORTED),			\
	BUILD_STATUS_CODE(TDX_SMRR_NOT_SUPPORTED),			\
	BUILD_STATUS_CODE(TDX_INCONSISTENT_MSR),			\
	BUILD_STATUS_CODE(TDX_INCORRECT_MSR_VALUE),			\
	BUILD_STATUS_CODE(TDX_SEAMREPORT_NOT_AVAILABLE),		\
	BUILD_STATUS_CODE(TDX_PERF_COUNTERS_ARE_PEBS_ENABLED),		\
	BUILD_STATUS_CODE(TDX_INVALID_TDMR),				\
	BUILD_STATUS_CODE(TDX_NON_ORDERED_TDMR),			\
	BUILD_STATUS_CODE(TDX_TDMR_OUTSIDE_CMRS),			\
	BUILD_STATUS_CODE(TDX_TDMR_ALREADY_INITIALIZED),		\
	BUILD_STATUS_CODE(TDX_INVALID_PAMT),				\
	BUILD_STATUS_CODE(TDX_PAMT_OUTSIDE_CMRS),			\
	BUILD_STATUS_CODE(TDX_PAMT_OVERLAP),				\
	BUILD_STATUS_CODE(TDX_INVALID_RESERVED_IN_TDMR),		\
	BUILD_STATUS_CODE(TDX_NON_ORDERED_RESERVED_IN_TDMR),		\
	BUILD_STATUS_CODE(TDX_CMR_LIST_INVALID),			\
	BUILD_STATUS_CODE(TDX_EPT_WALK_FAILED),				\
	BUILD_STATUS_CODE(TDX_EPT_ENTRY_FREE),				\
	BUILD_STATUS_CODE(TDX_EPT_ENTRY_NOT_FREE),			\
	BUILD_STATUS_CODE(TDX_EPT_ENTRY_NOT_PRESENT),			\
	BUILD_STATUS_CODE(TDX_EPT_ENTRY_NOT_LEAF),			\
	BUILD_STATUS_CODE(TDX_EPT_ENTRY_LEAF),				\
	BUILD_STATUS_CODE(TDX_GPA_RANGE_NOT_BLOCKED),			\
	BUILD_STATUS_CODE(TDX_GPA_RANGE_ALREADY_BLOCKED),		\
	BUILD_STATUS_CODE(TDX_TLB_TRACKING_NOT_DONE),			\
	BUILD_STATUS_CODE(TDX_EPT_INVALID_PROMOTE_CONDITIONS),		\
	BUILD_STATUS_CODE(TDX_PAGE_ALREADY_ACCEPTED),			\
	BUILD_STATUS_CODE(TDX_PAGE_SIZE_MISMATCH)
