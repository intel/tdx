...
static inline u64 seamcall_sept(u64 op, u64 rcx, u64 rdx, u64 r8, u64 r9,
				u64 r10, union tdx_ex_ret *ex)
{
	u64 ret;

	do {
		ret = seamcall(op, rcx, rdx, r8, r9, r10, ex);
			    ...
			    union tdx_ex_ret *ex)
{
	...
	return seamcall_sept(TDH_MEM_PAGE_ADD, gpa, tdr, hpa, source, 0, ex);
}
			    ...
			    union tdx_ex_ret *ex)
{
	...
	return seamcall_sept(TDH_MEM_SEPT_ADD, gpa | level, tdr, page, 0, 0, ex);
}
...
{
	tdx_clflush_page(hpa);
	return seamcall_sept(TDH_MEM_PAGE_AUG, gpa, tdr, hpa, 0, 0, ex);
}

static inline u64 tdh_mem_range_block(hpa_t tdr, gpa_t gpa, int level,
			  union tdx_ex_ret *ex)
{
	return seamcall_sept(TDH_MEM_RANGE_BLOCK, gpa | level, tdr, 0, 0, 0, ex);
}
...
static inline u64 tdh_mem_page_remove(hpa_t tdr, gpa_t gpa, int level,
				union tdx_ex_ret *ex)
{
	return seamcall_sept(TDH_MEM_PAGE_REMOVE, gpa | level, tdr, 0, 0, 0, ex);
}
...
static inline u64 tdh_mem_range_unblock(hpa_t tdr, gpa_t gpa, int level,
			    union tdx_ex_ret *ex)
{
	return seamcall_sept(TDH_MEM_RANGE_UNBLOCK, gpa | level, tdr, 0, 0, 0, ex);
}
