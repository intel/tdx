...
#define TDG_VP_VMCALL_SETUP_EVENT_NOTIFY 0x10004
...
#define TDG_VP_VMCALL_STATUS_INVALID_OPERAND 0x8000000000000000ULL
#define TDG_VP_VMCALL_STATUS_ALIGN_ERROR 0x8000000000000002ULL
