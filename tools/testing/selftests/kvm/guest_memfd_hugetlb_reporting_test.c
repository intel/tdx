...
static unsigned long hugetlb_baseline[NR_TEST_SIZES][NR_TESTED_HUGETLB_STATISTICS];
static unsigned long hugetlb_cgroup_baseline[NR_TEST_SIZES][NR_TESTED_HUGETLB_CGROUP_STATISTICS][NR_HUGETLB_CGROUP_STATISTIC_CATEGORIES];
