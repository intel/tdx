...
} efi_cc_boot_service_capability_t;

#define EFI_CC_EVENT_HEADER_VERSION  1

#define EFI_CC_BOOT_HASH_ALG_SHA384     0x00000004

typedef union efi_cc_measurement_protocol efi_cc_measurement_protocol_t;

union efi_cc_measurement_protocol {
	struct {
		efi_status_t (__efiapi *get_capability)(efi_cc_measurement_protocol_t *,
						       efi_cc_boot_service_capability_t *);
		efi_status_t (__efiapi *get_event_log)(efi_cc_measurement_protocol_t *,
						       efi_cc_event_log_format_t,
						       efi_physical_addr_t *,
						       efi_physical_addr_t *,
						       efi_bool_t *);
		efi_status_t (__efiapi *hash_log_extend_event)(efi_cc_measurement_protocol_t *,
							       u64,
							       efi_physical_addr_t,
							       u64,
							       const efi_cc_event_t *);
		efi_status_t (__efiapi *map_pcr_to_mr_index)(efi_cc_measurement_protocol_t *,
							     u32,
							     efi_cc_mr_index_t *);
	};
	struct {
