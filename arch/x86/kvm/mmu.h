...
static inline bool kvm_mmu_supports_shared_bit(const struct kvm *kvm)
{
	return !!kvm_gfn_shared_mask(kvm);
}

static inline gpa_t kvm_gpa_unalias(const struct kvm *kvm, gpa_t gpa)
{
	return gpa & ~gfn_to_gpa(kvm_gfn_shared_mask(kvm));
}

static inline gfn_t kvm_gfn_unalias(const struct kvm *kvm, gfn_t gfn)
{
...
static inline bool kvm_is_private_gfn(const struct kvm *kvm, gfn_t gfn)
{
