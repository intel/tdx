...
* vcpu 1: atomically update 2M level EPT entry to be present
* vcpu 2: read 2M level EPT entry that is present
* vcpu 2: walk down into 4K level EPT
* vcpu 2: atomically update 4K level EPT entry to be present
...
By freezing the EPT entry, this race is prevented as follows.
...
* vcpu 2: resume guest execution
          Depending on vcpu 1 state, vcpu 2 may result in EPT violation again or
          make progress on guest execution
