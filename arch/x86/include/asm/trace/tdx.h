...
TRACE_EVENT(tdg_virtualization_exception,
	...
	TP_PROTO(u64 rip, u32 exit_reason, u64 exit_qual, u64 gpa,
		 u32 instr_len, u32 instr_info),

	TP_ARGS(rip, exit_reason, exit_qual, gpa, instr_len, instr_info),
...
TRACE_EVENT(tdx_module_call_exit,
	...
	TP_PROTO(u64 rax, u64 rcx, u64 rdx, u64 r8, u64 r9, u64 r10, u64 r11),
