 ...
 */
static struct seamldr_params *__no_sanitize_address alloc_seamldr_params(const void *module,
 ...
 * TDX module.
 */
static int tdx_load_module(const void *module, unsigned long module_size, const void *sigstruct,
			   unsigned long sigstruct_size, u64 scenario)
{
	struct seamldr_params *params;
